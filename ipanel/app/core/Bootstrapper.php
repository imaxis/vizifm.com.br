<?php
	...
	class Bootstrapper
	{
		...
		private static function init()
		{
            ...
            self::$_instance->conn->setCharset('utf8mb4');
            self::$_instance->conn->setCollate('utf8mb4_unicode_ci');
            self::$_instance->manager->setAttribute(Doctrine_Core::ATTR_DEFAULT_TABLE_CHARSET, 'utf8mb4');
            self::$_instance->manager->setAttribute(Doctrine_Core::ATTR_DEFAULT_TABLE_COLLATE, 'utf8mb4_unicode_ci');
