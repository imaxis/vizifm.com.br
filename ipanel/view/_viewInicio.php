...
acessosSite  = <?= $controlAcessos->getArrayAcessos("Site",30); ?>;
acessosAdmin = <?= $controlAcessos->getArrayAcessos("Admin",30); ?>;


plot1 = $.jqplot('chart', [acessosSite, acessosAdmin], {
    seriesDefaults:{renderer:$.jqplot.BarRenderer, rendererOptions:{barPadding:8, barMargin:5}},
	series:[
    ...
    axes:{xaxis:{renderer:$.jqplot.CategoryAxisRenderer, rendererOptions:{sortMergedLabels:true}}, yaxis:{min:0,  numberTicks:6}}
    });
  });
  </script>
