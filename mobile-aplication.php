...
<body class="not-front">
    ...
    <div id="main">
        ...
        <div class="breadcrumbs1_wrapper">
            <div class="container">
                <div class="breadcrumbs1"><a href="index.html">Home</a><span>/</span>Aplicativo</div>
            </div>
        </div>
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-7 animated" data-animation="fadeInLeft" data-animation-delay="300">
                        <img src="images/about01.png" alt="" class="img-responsive iphone1">
                    </div>
                    <div class="col-sm-5 animated" data-animation="fadeInRight" data-animation-delay="300">

                        <div class="about_wrapper">

                            <div class="title2">APLICATIVO VIZIFM</div>
                            <div class="title1" style="text-align: left; margin-top: 30px;">Faça o Download do Aplicativo Vizi FM e ouça nossa programação diretamente do seu celular</div>

                            <br>

                            <p>
                                Carinhosamente chamada de Vizi FM, sendo uma emissora comercial FM, seu perfil popular jovem, tem comunicação alegre e dinâmica, atende todos os gostos musicais com sua programação musical eclética, atingindo as classes A, B e C, conforme Índice de Desenvolvimento Humano da região, sempre atenta e direcionada para o jornalismo local, regional e nacional.
                            </p>

                            <div class="apps_wrapper">
                                <a href="#"><img src="images/app1.png" alt="" class="img-responsive"></a>
                                <a href="https://play.google.com/store/apps/details?id=com.vizi1041.app"><img src="images/app2.png" alt="" class="img-responsive"></a>
                            </div>
